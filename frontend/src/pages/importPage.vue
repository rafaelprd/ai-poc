...
import installmentPlansPanel from "../components/import/installmentPlansPanel.vue";
...
async function fetchAccounts(): Promise<void> {
    ...
    try {
        ...
        accounts.value = (result.accounts ?? []).map(
    ...
    <div class="importPageRoot">
        ...
        <div class="accountSelectorWrap">
            ...
            <p
                ...
                class="helperText"
            >
                No accounts found. Create an account via the Ingestion or
                Transactions section first.
            </p>
        </div>
            ...
            <div class="importPageCol">
                <div v-if="!selectedAccountId" class="emptyState">
                    ...
                    <p class="emptyStateText">
                        Choose a target account above to start uploading files.
                    </p>
                </div>
        ...
        <div v-if="selectedAccountId" class="importPageFullWidth">
            <installmentPlansPanel :account-id="selectedAccountId" />
        </div>
    </div>
</template>
