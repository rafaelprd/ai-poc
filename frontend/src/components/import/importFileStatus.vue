...
<template>
    <div
        ...
        :class="{
            fileStatusFailed: isFailed,
            fileStatusCompleted: isCompleted,
        }"
    >
        ...
        <div class="fileStatusBody">
            ...
            <div
                v-if="
                    isCompleted ||
                    (isPending && file.transactionsCount !== null)
                "
            ...
            >
                ...
                <template v-if="file.installmentSkipped > 0">
                    <span class="countDivider" aria-hidden="true" />
                    <span class="countChip countChipInstSkipped">
                        <span class="countValue">{{
                            file.installmentSkipped
                        }}</span>
                        <span class="countLabel">inst. skipped</span>
                    </span>
                </template>
            </div>
            ...
            <!-- Processing hint -->
            <p
                v-if="isPending && file.transactionsCount === null"
                class="helperText fileStatusHint"
            >
                {{
            ...
            <p
                ...
                class="errorText fileStatusError"
            >
                {{ file.errorMessage }}
            </p>
        </div>
...
.countChipInstSkipped .countValue {
    color: hsl(var(--warning));
}
