...
const isTerminal = computed(() =>
    importDetail.value
        ? TERMINAL_STATUSES.has(importDetail.value.status)
        : false,
);
        ...
        <template v-if="importDetail">
            ...
            <div class="rowBetween trackerHeader">
                <div class="stackSm">
                    ...
                    <p class="helperText">
                        {{ statusLabel(importDetail.status) }}
                    </p>
                </div>
                ...
                <div class="kpiRow trackerKpis">
                    ...
                    <article class="kpiCard">
                        <p class="kpiValue">
                            {{ importDetail.newTransactions }}
                        </p>
                        <p class="kpiLabel">New txns</p>
                    </article>
                    <article class="kpiCard">
                        <p class="kpiValue">
                            {{ importDetail.duplicateTransactions }}
                        </p>
                        <p class="kpiLabel">Duplicates</p>
                    </article>
                    <article
                        class="kpiCard"
                        :class="{ kpiCardAlert: importDetail.failedFiles > 0 }"
                    >
            ...
            <div class="trackerProgressWrap">
                <div class="rowBetween trackerProgressLabel">
                    <span class="helperText">
                        {{ doneFilesCount }} /
                        {{ importDetail.totalFiles }} files processed
                    </span>
                    ...
                    <div
                        ...
                        :class="{
                            progressBarFillError:
                                importDetail.failedFiles > 0 && isTerminal,
                        }"
                    />
                </div>
            </div>
            ...
            <!-- Per-file statuses -->
            <div
                v-if="importDetail.files && importDetail.files.length"
                class="list"
            >
                <importFileStatus
                    ...
                    :file="{
                        ...
                        installmentSkipped: file.installmentSkipped ?? 0,
            ...
            <div v-else class="emptyState">
                ...
                <p class="emptyStateText">
                    File statuses will appear once processing begins.
                </p>
            </div>
        </template>
    </div>
